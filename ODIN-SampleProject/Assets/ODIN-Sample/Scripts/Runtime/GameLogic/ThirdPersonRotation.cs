    ...
    public class ThirdPersonRotation : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            else
            {
                ...
                float customRotation = rotation.action.ReadValue<float>();
        ...
        /// <summary>
        ///     Interpolates <see cref="rotationTarget" /> towards <see cref="targetRotation" /> based on
        ...
        private void RotateTowards(Quaternion targetRotation)
        {
            ...
            rotationTarget.transform.rotation =
                Quaternion.Lerp(rotationTarget.transform.rotation, targetRotation, lerpValue);
        }
    }
}