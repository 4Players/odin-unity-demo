...
namespace ODIN_Sample.Scripts.Runtime.Audio
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "DirectionalAudioEffectSettings",
        menuName = "Odin-Sample/DirectionalAudioEffectSettings", order = 0)]
    public class DirectionalAudioEffectSettings : ScriptableObject
    {
        ...
        /// <summary>
        ///     Returns a cutoff frequency given an angle. Based on the mapping of the angle to a cutoff frequency given by
        ///     <see cref="CutoffFrequencyCurve" />.
        /// </summary>
        ...
        /// <summary>
        ///     Returns a volume multiplier given an angle. Based on the mapping of the angle to a volume Multiplier given by
        ///     <see cref="VolumeCurve" />.
        /// </summary>
        /// <param name="angle">Angle (usually between audio listener and audio source).</param>
        ...
        {
            var currentVolume = GetVolume(angle);
            var currentCutoffFrequency = GetCutoffFrequency(angle);
